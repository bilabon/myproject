...
MIDDLEWARE_CLASSES = (
    ...
    'myapp.avatars.CustomSocialAuthExceptionMiddleware',
...
LINKEDIN_EXTRA_FIELD_SELECTORS = ['email-address', 'picture-url',]
LINKEDIN_EXTRA_DATA = [
                    ('id', 'id'),
...
FACEBOOK_APP_ID='<INSERT KEY>'
FACEBOOK_API_SECRET='<INSERT KEY>'

TWITTER_CONSUMER_KEY='<INSERT KEY>'
TWITTER_CONSUMER_SECRET='<INSERT KEY>'

GOOGLE_OAUTH2_CLIENT_ID = '<INSERT KEY>'
GOOGLE_OAUTH2_CLIENT_SECRET = '<INSERT KEY>'

LINKEDIN_CONSUMER_KEY = '<INSERT KEY>'
LINKEDIN_CONSUMER_SECRET = '<INSERT KEY>'
